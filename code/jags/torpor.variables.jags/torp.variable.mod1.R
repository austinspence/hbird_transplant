model{
  for(i in 1:torpor.variables.obs){
    ...
    mu.d[i] <- b0.d + b.d.elev*elev[i] + b.d.location*location[i] + 
      b.d.sex*sex[i] + b.d.mass*mass[i] + 
      b.d.min.temp*min.temp[i]  + ind.d[id[i]]
    ...
    mu.hes[i] <- b0.h + b.h.elev*elev[i] + b.h.location*location[i] + 
      b.h.sex*sex[i] + b.h.mass*mass[i]  + 
      b.h.min.temp*min.temp[i] + ind.h[id[i]]
    ...
    mu.nee[i] <- b0.n + b.n.elev*elev[i] + b.n.location*location[i] + 
      b.n.sex*sex[i] + b.n.mass*mass[i] +  
      b.n.min.temp*min.temp[i]  + ind.n[id[i]]
